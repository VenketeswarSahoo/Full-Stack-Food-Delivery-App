  ...
  return (
    <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="flex flex-col items-start justify-start gap-6">
        ...
        <p className="text-[40px] text-headingColor md:text-[56px] font-sans font-extrabold tracking-wider">
          The Fastest Delivery in{" "}
          <span className="text-orange-600"> Your City</span>
        </p>
        <p className="text-textColor text-lg">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae
          illum inventore aliquam! Ducimus, dignissimos. Sed at soluta quisquam
          libero maxime, vel ad laborum, consectetur alias ex sapiente
          voluptatem hic eligendi.
        </p>
        <motion.button
          {...buttonClick}

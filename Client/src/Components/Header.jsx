        ...
        {user ? (
          <> <div className=" relative cursor-pointer" onMouseEnter={()=> setIsMenu(true)}>
            ...
            {isMenu && (
              <motion.div 
              {...slideTop}
              onMouseLeave={()=> setIsMenu(false )} className="px-6 py-4 w-48 bg-lightOverlay backdrop-blur-md rounded-md shadow-md absolute top-12 right-0 flex flex-col gap-4">

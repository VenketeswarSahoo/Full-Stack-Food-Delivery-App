    ...
    >
      <div className="w-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <p
            className={`text-base font-semibold capitalize border border-gray-300 px-2 py-[2px] ${
                 ...
                 data.items.map((item, j) => {
                    return (
                        ...
                        <div className="flex items-start gap-2">
                            ...
                            <p className="flex items-center gap-1 text-textColor"><HiCurrencyRupee className="text-base text-red-500" />{parseFloat(item.product_price).toFixed(2)}</p>
                        </div>
                        </div>
                    </motion.div>
                    )
